...
<html lang="en">
	...
	<body>
		...
		<nav>
			<div class="navbar">
				<div class="nav_logo d-flex align-center">
					<h2>ARTISM</h2>
				</div>
				<div class="nav_li">
					...
					<div class="input_search d-flex">
						<input type="text" />
						<i class="fas fa-times font-16" id="remove"></i>
					</div>
				</div>
				<div class="nav_btn">
					...
					<a href="./registration_page/registration.php">
		...
		<div class="container">
			<div class="text d-flex align-center">
				<div class="inner">
					...
					<br /><br />
					<button><a href="./aboutUs_page/aboutUs.html">About Us</a></button>
				</div>
			</div>
			<div class="img d-flex align-center">
				<img src="./assets/home_img.jpg" alt="" />
			</div>
